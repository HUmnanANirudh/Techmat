      ...
      <div className="flex flex-col justify-center items-start w-full md:w-1/3">
        <div className="flex flex-col justify-center items-center text-start space-y-2 p-4">
          ...
          <p className="text-base md:text-lg text-justify">
            Our Unit 1 facility in Bhiwadi stands as a premier commercial heat
            treatment plant, catering to leading OEMs and Tier 1 & Tier 2
            companies across both automotive and non-automotive sectors. With
            cutting-edge technology and a commitment to quality, we deliver
            industry-leading heat treatment solutions that set new benchmarks
            for precision and reliability. A fully equipped Metallurgy Lab
            enables rigorous quality control, ensuring every process meets the
            highest industry standards.
          </p>
          <p className="text-base md:text-lg text-justify">
            Equipped with advanced machinery, including two 1000kg Sealed Quench
            Furnaces, two 600kg Gas Nitriding Furnaces, three 600kg Gas
            Carburizing Furnaces, and a Tumblast Shot Blasting unit, our
            facility ensures comprehensive treatment capabilities. To guarantee
            uninterrupted operations, our Bhiwadi Unit 1 is designed for
            efficiency and reliability, ensuring on-time service delivery while
