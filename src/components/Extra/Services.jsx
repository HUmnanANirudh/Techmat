...
const Services = () => {
    return (
      <div className="flex flex-col justify-center items-center p-6 lg:my-28">
        <div className="flex flex-col lg:flex-row justify-center items-center mb-10">
          ...
          className="flex justify-center items-center mb-6 lg:mb-0 lg:mr-10 p-2">
            <img
              src={Process}
          ...
          whileInView={{opacity:1,x:0}}
          viewport={{once:true}}
          transition={{duration:1,ease:"easeInOut"}}className="max-w-xl text-start lg:text-left lg:mb-10">
        ...
        whileInView={{opacity:1,x:0}}
        viewport={{once:true}}
        transition={{duration:1,ease:"easeInOut"}} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 w-full md:p-12 lg:p-4 max-w-[1200px]">
          <motion.div
